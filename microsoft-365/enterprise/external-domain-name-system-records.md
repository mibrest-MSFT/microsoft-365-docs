...
These DNS records apply only to tenants in Teams-only mode, for hybrid tenants, see [DNS implications for organizations that become hybrid](https://learn.microsoft.com/en-us/skypeforbusiness/hybrid/configure-hybrid-connectivity#dns-implications-for-on-premises-organizations-that-become-hybrid)

|DNS record|Purpose|Values to use|
|---|---|---|
